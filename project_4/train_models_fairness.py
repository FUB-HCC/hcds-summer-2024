...
models = {
    "fairness_RandomForest": RandomForestClassifier(random_state=42),
    "fairness_LogisticRegression": LogisticRegression(max_iter=200, random_state=42),
    "fairness_DecisionTree": DecisionTreeClassifier(random_state=42),
    "fairness_NeuralNetwork": MLPClassifier(max_iter=200, random_state=42)
}
